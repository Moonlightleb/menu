const MENU_DATA = {
  store: {
    sm: {
      ...
      facebookUrl: null,
      instagramUrl:
        "https://www.instagram.com/moonlightehden?igsh=dzk3MjBmdXlyOWh4",
      whatsappUrl:
        "https://api.whatsapp.com/send/?phone=%2B9613574745&text&type=phone_number&app_absent=0",
    },
    ...
    updatedAt: "2024-12-12T10:56:16.077Z",
    __v: 0,
    aboutUs: "",
    aboutUsTranslation: {},
    ...
    storeLogo:
      "https://moonlightleb.github.io/menu/images/moonlight-logo-low.png",
    templateId: "2",
  },
  categories: [],
  sub_categories: [
  ...
  items: [
    ...
    },
    {
      ...
      label: "Hot Dog",
      description:
        "Hot dog, ketchup, mayo, mustard, tomatoes, lettuce, pickles.",
      order: 8,
      price: 2.5,
      hide: false,
      sizes: [],
    ...
    },
    {
      ...
      label: "Pizza Regular",
      description:
        "Ham, salami, cheese, olives, mushrooms, green pepper, sauce.",
      order: 20,
      price: 8,
      hide: false,
      sizes: [],
    ...
    },
    {
      ...
      label: "Chicken Steak",
      description:
        "Grilled chicken, cheese, mushrooms, mayo, lettuce, pickles.",
      order: 2,
      price: 5,
      hide: false,
      sizes: [],
